...
CHROMA_PERSIST_DIRECTORY = "chroma_db/agenda"
CHROMA_COLLECTION_NAME = "all"
CHROMA_SERVER_HOST = ""
CHROMA_SERVER_HTTP_PORT = ""
FILE_PATH = "ToolQA/data/external_corpus/agenda/agenda_descriptions_merged.jsonl"
...
def main(cuda_idxes, query):
    content = query_llm(cuda_idxes, query)
    print(content)
    return content


if __name__ == '__main__':
    query = "March 7th, 2022"
    db = main([0], query)
    print(f"finished running {db}")
